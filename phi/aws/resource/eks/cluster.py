...
class EksCluster(AwsResource):
    ...
    resource_type_list: List[str] = ["eks-cluster", "eks"]
    ...
    def _create(self, aws_client: AwsApiClient) -> bool:
        ...
        """
        logger.info(f"Creating {self.get_resource_type()}: {self.get_resource_name()}")
        ...
        if eks_iam_role_arn is None and self.create_role:
            ...
            try:
                ...
                logger.info(f"ARN for {eks_iam_role.name}: {eks_iam_role_arn}")
        ...
        if resources_vpc_config is None and self.create_vpc_stack:
            logger.info("Creating default vpc stack as no resources_vpc_config provided")
        ...
        try:
            ...
            if self.created_at is not None:
                logger.info(f"EksCluster created: {self.name}")
    ...
    def post_create(self, aws_client: AwsApiClient) -> bool:
        ...
        if self.wait_for_create:
            try:
                logger.info(f"Waiting for {self.get_resource_type()} to be active.")
    ...
    def _delete(self, aws_client: AwsApiClient) -> bool:
        ...
        Args:
            aws_client: The AwsApiClient for the current cluster
        """
        logger.info(f"Deleting {self.get_resource_type()}: {self.get_resource_name()}")
    ...
    def post_delete(self, aws_client: AwsApiClient) -> bool:
        ...
        if self.wait_for_delete:
            try:
                logger.info(f"Waiting for {self.get_resource_type()} to be deleted.")
